...
<body>
    ...
    <div>
        ...
        <asp:ChangePassword ID="ChangePassword1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderPadding="4" BorderStyle="Solid" BorderWidth="1px" ConfirmPasswordCompareErrorMessage="Password confirmation must match." Font-Names="Verdana" Font-Size="Large" Height="191px" Width="394px">
